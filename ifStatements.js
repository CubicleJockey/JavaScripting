...
Conditional statements are used to alter the control flow of a program, based on
...
Inside parentheses you must enter a logic statement, meaning that the result of
the statement is either true or false.

The else block is optional and contains the code that will be executed if the st
atement is false.

## The challenge:

Create a file named ifStatement.js.
...
javascripting verify ifStatement.js
...
(function(){
	...
	if(fruit.length > 5){
		...
		console.log('The fruint name has five characters or less.');
	}
})();